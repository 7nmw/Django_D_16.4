...
'xY{A5)q<'
Модуль D8.
templates/email/email_confirmation_signup_message.html — файл, в котором будет храниться HTML самого письма.
templates/email/email_confirmation_subject.txt — файл, в котором хранится тема письма: Skillfactory sends it's regards
ADMINS = [
    ('Dean', 'Win.c4ester@yandex.ru'),
